...
public:
	...
	void Draw(const SpriteSheet& ss, const string& spriteName, const Vec2D& pos, const Color& overlayColor = Color::White());
	void Draw(const BitmapFont& font, const string& textLine, const Vec2D& pos, const Color& overlayColor = Color::White());
